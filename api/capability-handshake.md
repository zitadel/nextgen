...
participant Server
    ...
    Note left of Client: Client includes SemVer constraint<br/>in all subsequent flow calls.
    Client->>Server: POST /flows/session_id_1234/submit<br/>{"identifier": "user@example.com", "supported_versions": "^1.1.0"}
```
