...
func TestIdPConnectionMirrorMatchesSchema(t *testing.T) {
	...
	// The schema is generated from idp-connection.yaml and carries the
	// generator's marker; the mirror is written by hand.
	require.Equal(t, "Code generated by scripts/generate-meta-schemas.ts; DO NOT EDIT.", schema["$comment"],
		"the generator marker changed; update it here")
