				...
				case 'c': // Prefix: "chemas"
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "POST":
								s.handleCreateSchemaRevisionRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleGetSchemaByRevisionNrRequest([2]string{
										args[0],
										args[1],
									}, elemIsEscaped, w, r)
								default:
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								return r, true
							case "POST":
								r.name = CreateSchemaRevisionOperation
								r.summary = "Create new schema revision"
								r.operationID = "createSchemaRevision"
								r.operationGroup = ""
								r.pathPattern = "/schemas/{id}"
								r.args = args
								r.count = 1
						...
						case '/': // Prefix: "/"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = GetSchemaByRevisionNrOperation
									r.summary = "Get schema revision"
									r.operationID = "getSchemaByRevisionNr"
									r.operationGroup = ""
									r.pathPattern = "/schemas/{id}/{revision_nr}"
									r.args = args
									r.count = 2
									return r, true
								default:
