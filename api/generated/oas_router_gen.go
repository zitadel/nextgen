		...
		case '/': // Prefix: "/"
			...
			case 'i': // Prefix: "idps"
				...
				case '/': // Prefix: "/"
					...
					case 's': // Prefix: "slug/"
						origElem := elem
						if l := len("slug/"); len(elem) >= l && elem[0:l] == "slug/" {
							elem = elem[l:]
						} else {
							break
						}
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleGetIdpBySlugRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, notAllowedParams{
				...
				case '/': // Prefix: "/"
					...
					case 's': // Prefix: "slug/"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = GetIdpBySlugOperation
								r.summary = "Get an identity provider connection by slug"
								r.operationID = "getIdpBySlug"
								r.operationGroup = ""
								r.pathPattern = "/idps/slug/{slug}"
								r.args = args
								r.count = 1
								return r, true
							default:
