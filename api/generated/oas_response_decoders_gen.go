...
func decodeGetUserMetadataResponse(resp *http.Response) (res GetUserMetadataRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
	...
	case 400:
		...
		case ct == "application/json":
			...
			var response GetUserMetadataBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 401:
		...
		case ct == "application/json":
			...
			var response GetUserMetadataUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/json":
			...
			var response GetUserMetadataForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 404:
		...
		case ct == "application/json":
			...
			var response GetUserMetadataNotFound
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 500:
		...
		case ct == "application/json":
			...
			var response GetUserMetadataInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	// Default response.
	res, err := func() (res GetUserMetadataRes, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
			return res, errors.Wrap(err, "parse media type")
		}
