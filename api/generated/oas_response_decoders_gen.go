...
func decodeCreateSchemaRevisionResponse(resp *http.Response) (res CreateSchemaRevisionRes, _ error) {
	...
	case 400:
		...
		case ct == "application/json":
			...
			var response CreateSchemaRevisionBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 409:
		...
		case ct == "application/json":
			...
			var response CreateSchemaRevisionConflict
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeGetSchemaByRevisionNrResponse(resp *http.Response) (res GetSchemaByRevisionNrRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetSchemaByRevisionNrOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 400:
		...
		case ct == "application/json":
			...
			var response GetSchemaByRevisionNrBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 404:
		...
		case ct == "application/json":
			...
			var response GetSchemaByRevisionNrNotFound
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	// Default response.
	res, err := func() (res GetSchemaByRevisionNrRes, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
			return res, errors.Wrap(err, "parse media type")
		}
