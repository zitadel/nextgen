...
func decodeCreateEnvironmentResponse(resp *http.Response) (res CreateEnvironmentRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response CreateEnvironmentOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	// Default response.
	res, err := func() (res CreateEnvironmentRes, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
			return res, errors.Wrap(err, "parse media type")
		}
		...
		case ct == "application/json":
			...
			var response CreateEnvironmentErrorResponse
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
			...
			return &CreateEnvironmentErrorResponseStatusCode{
				StatusCode: resp.StatusCode,
				Response:   response,
			}, nil
		default:
...
func decodeCreateFlowResponse(resp *http.Response) (res CreateFlowRes, _ error) {
	...
	case 201:
		...
		case ct == "application/json":
			...
			// Parse "X-Zitadel-Environment" header.
			{
				cfg := uri.HeaderParameterDecodingConfig{
				...
				if err := func() error {
					if err := h.HasParam(cfg); err == nil {
						if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
							var wrapperDotXZitadelEnvironmentVal string
							if err := func() error {
								val, err := d.DecodeValue()
								if err != nil {
									return err
								...
								wrapperDotXZitadelEnvironmentVal = c
								return nil
							}(); err != nil {
								return err
							}
							wrapper.XZitadelEnvironment.SetTo(wrapperDotXZitadelEnvironmentVal)
							return nil
						}); err != nil {
							return err
						}
					...
					return res, errors.Wrap(err, "parse X-Zitadel-Environment header")
				}
			}
			// Parse "X-Zitadel-Release" header.
			{
				cfg := uri.HeaderParameterDecodingConfig{
				...
				if err := func() error {
					if err := h.HasParam(cfg); err == nil {
						if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
							var wrapperDotXZitadelReleaseVal string
							if err := func() error {
								val, err := d.DecodeValue()
								if err != nil {
									return err
								...
								wrapperDotXZitadelReleaseVal = c
								return nil
							}(); err != nil {
								return err
							}
							wrapper.XZitadelRelease.SetTo(wrapperDotXZitadelReleaseVal)
							return nil
						}); err != nil {
							return err
						}
					...
					return res, errors.Wrap(err, "parse X-Zitadel-Release header")
				}
			}
			return &wrapper, nil
		default:
