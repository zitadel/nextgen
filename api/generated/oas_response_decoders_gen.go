...
func decodeCreateUserDefinitionResponse(resp *http.Response) (res CreateUserDefinitionRes, _ error) {
	switch resp.StatusCode {
	case 201:
		// Code 201.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response CreateUserDefinitionCreated
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 4:
		// Pattern 4XX.
		res, err := func() (res CreateUserDefinitionRes, err error) {
			ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
			if err != nil {
				return res, errors.Wrap(err, "parse media type")
			}
...
func decodeGetUserDefinitionByIdResponse(resp *http.Response) (res GetUserDefinitionByIdRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response GetUserDefinitionByIdOK
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 4:
		// Pattern 4XX.
		res, err := func() (res GetUserDefinitionByIdRes, err error) {
			ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
			if err != nil {
				return res, errors.Wrap(err, "parse media type")
			}
...
func decodeListUserDefinitionsResponse(resp *http.Response) (res ListUserDefinitionsRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			var response ListUserDefinitionsOKApplicationJSON
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 4:
		// Pattern 4XX.
		res, err := func() (res ListUserDefinitionsRes, err error) {
			ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
			if err != nil {
				return res, errors.Wrap(err, "parse media type")
			}
