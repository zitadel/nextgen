...
func decodePatchUserResponse(resp *http.Response) (res PatchUserRes, _ error) {
	...
	case 400:
		...
		case ct == "application/json":
			...
			var response PatchUserBadRequest
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 401:
		...
		case ct == "application/json":
			...
			var response PatchUserUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/json":
			...
			var response PatchUserForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 404:
		...
		case ct == "application/json":
			...
			var response PatchUserNotFound
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	// Default response.
	res, err := func() (res PatchUserRes, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
			return res, errors.Wrap(err, "parse media type")
		}
