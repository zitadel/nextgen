...
func decodeUpdateUserByIDResponse(resp *http.Response) (res UpdateUserByIDRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
	...
	case 401:
		...
		case ct == "application/json":
			...
			var response UpdateUserByIDUnauthorized
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 403:
		...
		case ct == "application/json":
			...
			var response UpdateUserByIDForbidden
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 404:
		...
		case ct == "application/json":
			...
			var response UpdateUserByIDNotFound
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	// Default response.
	res, err := func() (res UpdateUserByIDRes, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		if err != nil {
			return res, errors.Wrap(err, "parse media type")
		}
