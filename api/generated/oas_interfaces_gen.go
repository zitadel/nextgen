...
type BeginUserPasskeyRegistrationRes interface {
	beginUserPasskeyRegistrationRes()
}
...
type FinishUserPasskeyRegistrationRes interface {
	finishUserPasskeyRegistrationRes()
}
