...
func encodeBeginPasskeyRegistrationResponse(response BeginPasskeyRegistrationRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *BeginPasskeyRegistrationResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(201)
...
func encodeFinishPasskeyRegistrationResponse(response FinishPasskeyRegistrationRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *FinishPasskeyRegistrationResponse:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(201)
		span.SetStatus(codes.Ok, http.StatusText(201))
