...
func encodeGetUserMetadataResponse(response GetUserMetadataRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *UserMetadata:
		if err := func() error {
			if err := response.Validate(); err != nil {
	...
	case *GetUserMetadataBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
	...
	case *GetUserMetadataUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
		span.SetStatus(codes.Error, http.StatusText(401))
	...
	case *GetUserMetadataInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
