...
func encodeApplyProjectConfigResponse(response ApplyProjectConfigRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ApplyProjectConfigOK:
		if err := func() error {
	...
	case *ApplyProjectConfigUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
	...
	case *ApplyProjectConfigNotFound:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(404)
	...
	case *ApplyProjectConfigConflict:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(409)
...
func encodeCompleteProjectClaimResponse(response CompleteProjectClaimRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *CompleteProjectClaimOK:
		if err := func() error {
			if err := response.Validate(); err != nil {
				return err
			}
	...
	case *CompleteProjectClaimUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
		span.SetStatus(codes.Error, http.StatusText(401))
	...
	case *CompleteProjectClaimNotFound:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(404)
		span.SetStatus(codes.Error, http.StatusText(404))
	...
	case *CompleteProjectClaimConflict:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(409)
		span.SetStatus(codes.Error, http.StatusText(409))
...
func encodeCreateProjectResponse(response CreateProjectRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *CreateProjectTooManyRequests:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(429)
...
func encodeGetProjectClaimStatusResponse(response GetProjectClaimStatusRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *GetProjectClaimStatusOK:
		if err := func() error {
			if err := response.Validate(); err != nil {
				return err
			}
	...
	case *GetProjectClaimStatusUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
		span.SetStatus(codes.Error, http.StatusText(401))
	...
	case *GetProjectClaimStatusNotFound:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(404)
		span.SetStatus(codes.Error, http.StatusText(404))
	...
	case *GetProjectClaimStatusGone:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(410)
		span.SetStatus(codes.Error, http.StatusText(410))
...
func encodeInitProjectClaimResponse(response InitProjectClaimRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *InitProjectClaimCreated:
		if err := func() error {
			if err := response.Validate(); err != nil {
				return err
			}
	...
	case *InitProjectClaimUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
		span.SetStatus(codes.Error, http.StatusText(401))
