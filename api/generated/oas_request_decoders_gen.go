...
func (s *Server) decodeBeginPasskeyRegistrationRequest(r *http.Request) (
	req *BeginPasskeyRegistrationRequest,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request BeginPasskeyRegistrationRequest
		if err := func() error {
...
func (s *Server) decodeFinishPasskeyRegistrationRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request FinishPasskeyRegistrationRequest
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
