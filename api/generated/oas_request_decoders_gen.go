...
func (s *Server) decodeApplyProjectConfigRequest(r *http.Request) (
	req OptApplyProjectConfigReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request OptApplyProjectConfigReq
		if err := func() error {
			request.Reset()
...
func (s *Server) decodeCompleteProjectClaimRequest(r *http.Request) (
	req *CompleteProjectClaimReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request CompleteProjectClaimReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeInitProjectClaimRequest(r *http.Request) (
	req OptInitProjectClaimReq,
	rawBody []byte,
	close func() error,
	rerr error,
) {
	...
	case ct == "application/json":
		...
		var request OptInitProjectClaimReq
		if err := func() error {
			request.Reset()
			if err := request.Decode(d); err != nil {
				return err
