...
func (s *Server) decodeCreateSchemaRevisionRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request CreateSchemaRevisionReq
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
...
func (s *Server) decodeUpdateSchemaReleaseStateRequest(r *http.Request) (
	...
	case ct == "application/json":
		...
		var request SchemaReleaseState
		if err := func() error {
			if err := request.Decode(d); err != nil {
				return err
			}
