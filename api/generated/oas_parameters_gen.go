...
// UpdateUserByIDParams is parameters of UpdateUserByID operation.
...
func unpackUpdateUserByIDParams(packed middleware.Parameters) (params UpdateUserByIDParams) {
	{
		key := middleware.ParameterKey{
			Name: "project_id",
			In:   "query",
...
func decodeUpdateUserByIDParams(args [1]string, argsEscaped bool, r *http.Request) (params UpdateUserByIDParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Decode query: project_id.
	if err := func() error {
		cfg := uri.QueryParameterDecodingConfig{
