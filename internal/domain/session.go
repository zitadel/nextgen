...
type Session struct {
	...
	// RevokedAt is set when the session was explicitly revoked. A revoked session
	// is kept (soft delete) so it remains visible; nil means not revoked.
	RevokedAt *time.Time
