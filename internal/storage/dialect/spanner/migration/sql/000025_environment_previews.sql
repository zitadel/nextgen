...
ALTER TABLE environments ADD COLUMN class STRING(16) NOT NULL DEFAULT ('live')
-- +goose StatementEnd
-- +goose StatementBegin
-- NULL on live: it never expires.
ALTER TABLE environments ADD COLUMN expires_at TIMESTAMP
-- +goose StatementEnd
-- +goose StatementBegin
...
ALTER TABLE environments ADD COLUMN origins JSON
-- +goose StatementEnd
