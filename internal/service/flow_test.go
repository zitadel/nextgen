...
func (testAllStatements) CreateTeamMembership(context.Context, *domain.TeamMembership) error {
	panic("unexpected call to CreateTeamMembership")
}

func (testAllStatements) GetTeamMembership(context.Context, string, string, string) (*domain.TeamMembership, error) {
	panic("unexpected call to GetTeamMembership")
}

func (testAllStatements) ListTeamMembershipsByUser(context.Context, string, string) ([]*domain.TeamMembership, error) {
	panic("unexpected call to ListTeamMembershipsByUser")
}

func (testAllStatements) ListTeamMembershipsByTeam(context.Context, string, string) ([]*domain.TeamMembership, error) {
	panic("unexpected call to ListTeamMembershipsByTeam")
}

func (testAllStatements) UpdateTeamMembershipStatus(context.Context, string, string, string, domain.MembershipStatus) error {
	panic("unexpected call to UpdateTeamMembershipStatus")
}
