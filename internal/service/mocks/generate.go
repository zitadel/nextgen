...
//go:generate go tool mockgen -typed -package mocks -destination ./service.mock.go github.com/zitadel/nextgen/internal/service StatementPool,Statements,AllStatements,ProjectStatements,FlowDefinitionStatements,CryptoKeyStatements,JSONSchemaStatements,TeamStatements,TeamMembershipStatements,TokenStatements,SessionStatements,AuthAttemptStatements,UserStatements,UserPasswordStatements,UserTOTPStatements,UserPasskeyStatements,UserRecoveryCodesStatements,BrandingStatements,PolicyStatements,VariableStatements,ClaimStatements,ResourceScopeStatements,AuthzAssignmentStatements,AuthzMembershipEdgeStatements,AuthzCatalogStatements,AuthzResolverStatements,EventStatements,Pool,Transactioner,Statementer,SessionService,TokenService,KeyService,ClaimService,ProjectService,VariableService,ReleaseService,SessionResolver,UserLookup,UserAction
