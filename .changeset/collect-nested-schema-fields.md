...
satisfied by a step collecting `address.street`. Naming an object- or
array-typed property directly is rejected when the flow definition is saved
instead of failing part way through the flow.
