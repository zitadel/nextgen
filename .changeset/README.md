...
server containers. Moon also creates or updates the product `v<version>` tag and
draft GitHub Release shell with generated artifact and package facts. Manual
...
update the product `v<version>` tag and draft GitHub Release shell. Product
release prose is written manually by maintainers before they publish the draft.
See
