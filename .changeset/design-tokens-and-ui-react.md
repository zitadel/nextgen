...
"@zitadel-nextgen/design-tokens": minor
"@zitadel-nextgen/ui-react": minor
---

Introduce the design-token-driven foundation for the auth surface, replacing
the demo styling baseline:

- New `@zitadel-nextgen/design-tokens` package — the single producer of the
...
- New `@zitadel-nextgen/ui-react` package — visually identical paired React components
