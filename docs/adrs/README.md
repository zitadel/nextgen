...
| [002](002-multi-package-release-strategy.md) | Lockstep Zitadel v5 Alpha Preview Release Train | One v5 alpha version covers runtime, CLI, SDKs, and Docker. Changesets owns versions/changelogs/npm; GoReleaser owns the single GitHub Release and runtime artifacts. |
