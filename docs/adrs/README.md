...
| [002](002-multi-package-release-strategy.md) | Multi-package Release Strategy | Moon owns the repo task graph, non-npm artifact builds, and the product GitHub Release; Changesets owns package versions, changelogs, npm publishing, and public package tags. |
