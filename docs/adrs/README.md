...
| [023](023-user-team-lifecycle-ownership.md) | User, Team, and Lifecycle Ownership | Users are project-scoped identities; each user has one lifecycle owner (`self` or `team`); team participation is separate from lifecycle ownership; delete operations deactivate/tombstone before purge. |
