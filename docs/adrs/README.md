...
| [002](002-multi-package-release-strategy.md) | Multi-package Release Strategy | Moon owns the repo task graph and non-npm artifact builds; Changesets owns package versions, changelogs, npm publishing, and package tags. |
