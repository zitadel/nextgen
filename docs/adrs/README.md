...
| [023](023-lockstep-alpha-release-train.md) | Lockstep Alpha Release Train | Public nextgen alpha releases use one `0.1.0-alpha.N` train version across npm packages, the CLI, server image, and GoReleaser artifacts, with one GitHub Release named `ZITADEL Alpha <version>`. |
