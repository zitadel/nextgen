...
| [022](022-user-team-lifecycle-ownership.md) | User, Team, Membership, and Lifecycle Ownership | Users are project-scoped identities; memberships attach users to teams; each user has one lifecycle owner (`self` or `team`); delete operations deactivate/tombstone before purge. |
