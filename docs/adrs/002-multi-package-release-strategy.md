...
3. **Moon publishes non-npm product artifacts.**
   ...
   `ghcr.io/zitadel/nextgen:<version>`. Product GitHub Release notes are a
   manual maintainer artifact when an announcement is needed.
...
- Product release notes stay human-written instead of being generated by the
  release script.
