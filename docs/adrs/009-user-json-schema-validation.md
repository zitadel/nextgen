...
SQL-oriented put/patch contracts under `internal/storage/dialect/postgres/migration/004_users/example/` already reflect single-transaction user updates; HTTP APIs should preserve that atomicity.
