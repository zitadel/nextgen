...
> below, therefore describe the future target, not MVP claim. The MVP claim
> lifecycle is shipped: the server serves the claim endpoints and the CLI
> provides `zitadel claim`.
