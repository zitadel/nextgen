...
| [Login customization strategy](../branding/customization-strategy.md) | Proposed | Placement map under #678 / #936: three presentation models, first iteration branding settings, voice as a separate setting ([ADR 057](../../adrs/057-login-customization-categories.md)). |
