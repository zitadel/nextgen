...
| [Login customization strategy](../branding/customization-strategy.md) | Proposed | Shared **widget template** vs hosted-only **page template**; appearance knobs; embedder wrappers ([ADR 056](../../adrs/056-login-customization-categories.md)). |
