...
| [Login customization strategy](../branding/customization-strategy.md) | Proposed | Where page chrome, widget knobs, Liquid structure, copy, and flow live for embedded vs hosted login ([ADR 056](../../adrs/056-login-customization-categories.md)). |
