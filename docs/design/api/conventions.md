...
| **Pagination** | Opaque cursor (`page_token` in, `next_page_token` out). `limit` default 20, max 100 ([`limit.yaml`](../../../api/openapi/components/schemas/limit.yaml)). Canonical rules in [`api/openapi/readme.md`](../../../api/openapi/readme.md). |
