...
| **page template** | Hosted-only Liquid document (`page.liquid`) with a required `{% login_widget %}` hole. Parallel to **widget template**; it does not apply to embeds — those wrap in app code. |
