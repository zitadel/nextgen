...
- **Scoping the presence check:** Requiring secret validation before a plan
  ...
  inside interactive journeys and test preflight, and batch `plan` warns.
