...
Built-ins and tokens shipped first; hand-written Liquid is live via the CLI eject workflow ([`templates.md`](templates.md), [ADR 037](../../adrs/037-tenant-login-templates-editable-config.md)); a block editor that emits Liquid layers on the same validator later.

## Open points

Dark mode; i18n source; powered-by line. Settled elsewhere: template attachment + grouping ([ADR 037](../../adrs/037-tenant-login-templates-editable-config.md)), extra designs via the catalog ([`templates.md`](templates.md)), untrusted CSS rejected ([`schema.md`](schema.md)).
