 ...
 * ## Runtime note
 *
 * This file targets the **Next.js Edge runtime** and must not use Node.js APIs.
 * `base64UrlDecode` therefore uses `atob` rather than `Buffer`. The equivalent
 * Nuxt/Nitro file (`sdk-nuxt/src/runtime/lib/jwt.ts`) uses `Buffer` instead —
