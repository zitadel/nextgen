...
| - | --- | --- | --- | --- |
| 1 | **Legacy login** | `--zl-color-surface-default-black`, `--zl-color-text-button-*`, `--zl-color-gray-*` | `packages/shared-component-styles/*` (paired Lit+React atoms; dark-only, ADR-014 §5) | yes — frozen in `src/legacy.tokens.json` |
