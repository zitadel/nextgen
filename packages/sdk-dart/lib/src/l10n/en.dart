...
///
/// Hand-ported from `packages/components/src/orchestrator/locales/en.ts` —
/// keep the two in sync when copy changes (automated sync is tracked as a
/// deferred item in `docs/design/sdk-flutter/PLAN.md`).
///
