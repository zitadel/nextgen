/**
 * Thin wrappers around the orval-generated `@zitadel/api-client` fetch
 ...
 *
 * Types come straight from `@zitadel/api-client/generated/model`. Orval
 ...
 */
import type { ZitadelApi } from "@zitadel/api-client/config";
import type {
  CreateFlow201,
  CreateFlowBody,
  ExchangeHandoff200,
...
import { ApiError } from "@zitadel/api-client/runtime/fetch";
