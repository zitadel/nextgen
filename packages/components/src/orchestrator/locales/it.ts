...
export const it: Locale = {
  ...
  "register.field.maritalStatus": "Stato civile",
  "register.field.maritalStatus.placeholder": "Seleziona il tuo stato civile",
  "register.field.newsletterOptIn": "Inviami la newsletter",
