...
export const en: Record<string, string> = {
  ...
  "register.field.maritalStatus": "Marital status",
  "register.field.maritalStatus.placeholder": "Select your marital status",
  "register.field.newsletterOptIn": "Send me the newsletter",
