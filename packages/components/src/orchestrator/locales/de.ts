...
export const de: Locale = {
  ...
  "register.field.maritalStatus": "Familienstand",
  "register.field.maritalStatus.placeholder": "Familienstand auswählen",
  "register.field.newsletterOptIn": "Newsletter abonnieren",
