 ...
 * fields. Pure: returns a freshly-allocated, key-sorted object. The
 * single entry point that constructs the resource, paralleling
 * `lib/flows`' `buildFlow` — same `(method, fields)` argument order.
 *
