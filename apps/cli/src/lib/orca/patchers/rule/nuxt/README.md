...
- `nuxt.config.ts` — registers `@zitadel/sdk-nuxt/module`, sets the login path, seeds `runtimeConfig` (backend URL, proxy path, project id), and adds the components to `build.transpile`
