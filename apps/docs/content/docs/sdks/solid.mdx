---
title: Solid SDK
description: Client-side Solid wrappers for the Zitadel login and logout components.
---
...
<Callout title="SPA proxy requirement" type="warn">
  Solid apps do not have server middleware by default. The CLI configures a Vite dev proxy; production deployments need an equivalent same-origin proxy for `/__nextgen/*`. See [SDK proxy](/docs/concepts/sdk-proxy).
</Callout>
...
- [`@zitadel/sdk-solid` source](https://github.com/zitadel/nextgen/tree/main/packages/sdk-solid) and the [CLI Solid patcher](https://github.com/zitadel/nextgen/tree/main/apps/cli/src/lib/orca/patchers/rule/solid).
